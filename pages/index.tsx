...
export default function Home() {
  return (
    <div className='flex flex-col h-screen md:min-h-screen'>
      <div className="flex flex-1 flex-col items-center justify-between px-6 py-16 md:px-24 md:pt-6 md:pb-52">
        ...
        <div className="mb-4 md:mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
          <a
